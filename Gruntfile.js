...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
      ...
      app: {
            ...
            dist: {
                files: [{
                    ...
                    src: ['*.{ico,png,txt}', '.htaccess', '*.html', 'views/{,*/}*.html',
                        // 'bower_components/**/*',
                        'bower_components/requirejs/require.js', 'images/{,*/}*.{webp}', 'fonts/*'
                    ]
                }, {
                    expand: true,
                    cwd: '.tmp/images',
        ...
        concurrent: {
            server: ['less:dist', 'copy:styles'],
            test: ['less:dist', 'copy:styles'],
            dist: ['less:dist', 'copy:styles', 'imagemin', 'svgmin']
        },
    ...
    grunt.registerTask('serve', function(target) {
        ...
        grunt.task.run(['clean:server',
            // 'bower-install',
            'bower', 'concurrent:server', 'autoprefixer', 'connect:livereload', 'watch'
        ]);
    });
    ...
    grunt.registerTask('build', ['clean:dist',
        // 'bower-install',
        'bower', 'useminPrepare', 'concurrent:dist', 'autoprefixer', 'concat', 'ngmin', 'copy:dist', 'cssmin',
        // 'uglify',
        // 'rev',
        'usemin', 'requirejs', 'htmlmin'
    ]);
